...
public class MemberControllerProfileTest {
    ...
    @Test
    void loginAndGetProfile() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andDo(result -> {
                    ...
                    getProfile(loginResponseWebResponse.getData().getToken());

                });
    }

    void getProfile(String token) throws Exception {
        ...
        mockMvc.perform(get("/profile")
                ...
                .andDo(result -> {
                    String content = result.getResponse().getContentAsString();
                    WebResponse<ProfileViewResponse> prfileViewResponse = objectMapper.readValue(content, new TypeReference<WebResponse<ProfileViewResponse>>() {
                    });
                    System.out.println(prfileViewResponse);
                });
    }
